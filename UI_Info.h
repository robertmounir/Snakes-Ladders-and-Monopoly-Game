...
enum DESIGN_MODE_ITEMS // The items of the Design Mode (you should add more items)   //////////////not sure///////////
{
...
enum PLAY_MODE_ITEMS // The items of the Play Mode (you should add more items) //////////// NOT SURE////////////////
{
