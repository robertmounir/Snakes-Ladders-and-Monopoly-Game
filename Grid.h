...
public:
	...
	Cell* getCellPointer(CellPosition pos);
	// ========= Other Getters =========
	
	Player * GetCurrentPlayer() const;	// Gets a Pointer to the Current Player	                                    
	Ladder * GetNextLadder(const CellPosition & position); 
	...
	//bool OverlappingSnakesWithLadders (CellPosition & start , CellPosition &end);
	//bool OverlappingLaddersWithSnakes (CellPosition&start, CellPosition&end);
