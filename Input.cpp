...
ActionType Input::GetUserAction() const ////////////////////not sure ////////////////////
{	
	int x = -1, y = -1;
	GetPointClicked(x, y); 
	...
	else	
	{
		...
		//return TO_DESIGN_MODE;	// just for now ==> This should be updated ///////////////////not sure///////////////////
...
CellPosition Input::GetCellClicked() const
{
	...
	if ( UI.InterfaceMode == MODE_DESIGN )	
	{
		if ( y >= UI.ToolBarHeight && y <= (UI.height - UI.StatusBarHeight))
		{
			...
			cellPos.SetHCell(x/UI.CellWidth);//////////////not sure////////////////////
